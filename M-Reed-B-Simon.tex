...
\begin{equation*}
  ...
  c_{ l } d_{ k } \, (\vp_{ l } \cdot \psi_{ k } ) = f \cdot g,
\end{equation*}
gdzie $\cdot$ jest jakiegoś rodzaju iloczynem, a~symbol
...
\begin{twr}
  ...
  $l \in \N$, są~warunkowo zbieżne do~elementów $\eta_{ i }$, to
  zachodzi równość
  \begin{equation*}
...
powiedziane, że~$\int | f( p ) - f_{ n }( p ) | \dk p \ra 0$, co
