...
jakiego używa Fichtenholza (zobacz str.~??? \cite{FichtenholzRachunekRozniczkowyETCVolII2004})
...
wtedy:
\begin{equation*}
  \label{RS-Vol-I-s01-17}
  0 = ( Ux, \, Ux )_{ \Hcal_{ 2 } } = ( x, \, x (_{ \Hcal_{ 1 } }
  \iff x = 0.
\end{equation*}
% Sprawdzone.
